...
- (void)viewDidLoad {
    ...
    self.scrollView.backgroundColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:1];
...
-(void)createContentView:(NSDictionary *)info{
    ...
    //头像
    UIImageView *userImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 0, 40, 40)];
    ...
    //名称
    UILabel *userName = [[UILabel alloc] initWithFrame:CGRectMake(60, 0, [self boundingRectWithSize:CGSizeMake(kWidth, 0) string:info[@"uname"]].width+10, 40)];
    userName.font = kFont;
    userName.text = info[@"uname"];
    [ContentView addSubview:userName];
    //发帖时间
    UILabel *time = [[UILabel alloc] initWithFrame:CGRectMake(kWidth-[self boundingRectWithSize:CGSizeMake(kWidth, 0) string:info[@"create_time_geshi"]].width-20, 0, [self boundingRectWithSize:CGSizeMake(kWidth, 0) string:info[@"create_time_geshi"]].width+10, 40)];
    time.font = kFont;
    ...
    [ContentView addSubview:kaoshiLabel];
    //考试地点
    ...
    [ContentView addSubview:didianImageView];
    ...
    [ContentView addSubview:didianLabel];
    //Part1栏目
    ...
    [ContentView addSubview:part1Label];
    ...
    [ContentView addSubview:part2Label];
    ...
    for(int i=0; i<[info[@"images"] count];i++){
        ...
        [imageView setFrame:CGRectMake(5, imgY, imageView.image.size.width/3*2, imageView.image.size.height/3*2)];
        [ContentView addSubview:imageView];
        imgY += (imageView.image.size.height/3*2)+5;

    }
    }
    ContentView.backgroundColor = [UIColor whiteColor];
    [ContentView setFrame:CGRectMake(0, -64, kWidth, imgY)];
    [self.scrollView addSubview:ContentView];
    //点赞人数View
    UIView *praiseView = [[UIView alloc] initWithFrame:CGRectMake(0, ContentView.frame.origin.y+ContentView.frame.size.height+10, kWidth, 90)];
    praiseView.backgroundColor = [UIColor whiteColor];
    //点赞人数Label
    UILabel *praiseLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 100, 90)];
    praiseLabel.font = kFont;
    ...
    self.scrollView.contentSize = CGSizeMake(0, praiseView.frame.origin.y+praiseView.frame.size.height+74);
